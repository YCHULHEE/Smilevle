...
public class ReservationService {
	...
	public ReservationPage getReservationPage(int pageNum, String memberId, int size) {
		int total = reservationRepository.selectCount(memberId);
		List<ReservationVO> ReservationList = reservationRepository.getAdminReservationList((pageNum - 1) * size, size, memberId);
		return new ReservationPage(total, pageNum, size, ReservationList);
	}
