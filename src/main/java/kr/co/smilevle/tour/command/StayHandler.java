...
public class StayHandler implements CommandHandler{
	private ListTourService listTourService = new ListTourService();
	...
	public String process(HttpServletRequest req, HttpServletResponse res) throws Exception {
		...
		TourPage page = listTourService.getArticlePage(pageNo, areaCode, smallCategory, where, searchWord);
