						...
						<div class="destination" >
							...
							<div class="text p-3">
								...
								<p class="bottom-area d-flex">
									<span></span> <span class="ml-auto"><a href="/reservation?contentId=${stay.contentId}&title=${stay.title}">예약하기</a><span>  </span><a href="/review_write?stayId=${stay.contentId }" id="write">리뷰작성</a></span>
								</p>
							</div>
						</div>
					</div>
