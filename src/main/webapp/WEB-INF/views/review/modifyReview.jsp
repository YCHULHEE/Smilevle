  ...
  <jsp:include page="/WEB-INF/views/include/common/menu.jsp"/>
    ...
    <section class="ftco-section">
    	<div class="container">
			...
			<form action="/review_modifyAction" method="post">
			<input type="hidden" name="review_no" id="review_no" value="${modReq.review_no }">
				...
				<button class="btn btn-outline-info rounded float-right" onclick="submit">게시글 수정</button>
			</form>				
		</div>
    </section>
