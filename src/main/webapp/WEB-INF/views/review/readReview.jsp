    	...
    	<div class="container">
    		...
    		<div class="container">
    			<c:if test="${authUser.id == reviewData.writer.id }">
    			    <button type="button" class="btn btn-light float-right" onclick="location.href='review_delete.do'">삭제</button>
    				<button type="button" class="btn btn-light float-right" onclick="location.href='review_modify.do'">수정</button>
    			</c:if>
    		</div>
    	</div>
    </section>
